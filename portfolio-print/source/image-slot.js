...
(() => {
  ...
  const icon =
    '<svg part="icon" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" ' +
  ...
  class ImageSlot extends HTMLElement {
    static get observedAttributes() {
      return ['shape', 'radius', 'mask', 'fit', 'position', 'placeholder', 'src', 'id', 'sign'];
    }
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="sign" part="sign"></div>' + icon +
      ...
      this._sign = root.querySelector('.sign');
    ...
    _render() {
      ...
      if (this._sign) this._sign.textContent = this.getAttribute('sign') || '';
